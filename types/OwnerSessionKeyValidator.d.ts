...
interface OwnerSessionKeyValidatorInterface extends ethers.utils.Interface {
  functions: {
...
export class OwnerSessionKeyValidator extends Contract {
  ...
  functions: {
    ...
    "sessionKeyStorage(address,address)"(
      sessionKey: string,
      account: string,
      overrides?: CallOverrides
    ): Promise<{
