...
import type { ExecutionManager, ExecutionManagerInterface } from '../../../contracts/core/ExecutionManager'
...
export class ExecutionManager__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): ExecutionManager {
