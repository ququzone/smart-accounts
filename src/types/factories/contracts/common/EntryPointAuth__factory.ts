...
import type { EntryPointAuth, EntryPointAuthInterface } from '../../../contracts/common/EntryPointAuth'
...
export class EntryPointAuth__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): EntryPointAuth {
