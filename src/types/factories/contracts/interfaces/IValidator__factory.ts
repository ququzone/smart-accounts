...
import type { IValidator, IValidatorInterface } from '../../../contracts/interfaces/IValidator'
...
export class IValidator__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IValidator {
