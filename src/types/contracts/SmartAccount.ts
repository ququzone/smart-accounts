...
export interface SmartAccountInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'recovery', values: [string, BytesLike]): string
...
export type ChangedFallbackHandlerEvent = TypedEvent<[string, string], ChangedFallbackHandlerEventObject>
...
export interface SmartAccount extends BaseContract {
  ...
  functions: {
    addDeposit(overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
    ...
    getFallbackHandler(overrides?: CallOverrides): Promise<[string] & { _handler: string }>
    ...
    setFallbackHandler(handler: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  recovery(validator: string, data: BytesLike, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    recovery(validator: string, data: BytesLike, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    addDeposit(overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
    ...
    recovery(validator: string, data: BytesLike, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    setFallbackHandler(handler: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
  ...
  populateTransaction: {
    addDeposit(overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    setFallbackHandler(handler: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
