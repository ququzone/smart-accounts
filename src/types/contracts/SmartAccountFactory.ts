...
export interface SmartAccountFactoryInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'accountImplementation' | 'createAccount' | 'getAddress' | 'handler',
  ): FunctionFragment
...
export interface SmartAccountFactory extends BaseContract {
  ...
  getAddress(validators: string[], data: BytesLike[], salt: BigNumberish, overrides?: CallOverrides): Promise<string>
