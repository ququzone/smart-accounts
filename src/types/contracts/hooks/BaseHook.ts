...
export interface BaseHookInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'afterTransaction', values: [string, BigNumberish, BytesLike]): string
  encodeFunctionData(functionFragment: 'beforeTransaction', values: [string, BigNumberish, BytesLike]): string
  ...
  decodeFunctionResult(functionFragment: 'afterTransaction', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'beforeTransaction', data: BytesLike): Result
...
export interface BaseHook extends BaseContract {
  ...
  functions: {
    ...
    install(data: BytesLike, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    afterTransaction(to: string, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<void>

    beforeTransaction(to: string, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    install(data: BytesLike, overrides?: Overrides & { from?: string }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    install(data: BytesLike, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
