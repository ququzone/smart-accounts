...
export interface IAggregatorInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'aggregateSignatures' | 'validateSignatures' | 'validateUserOpSignature',
  ): FunctionFragment

  encodeFunctionData(functionFragment: 'aggregateSignatures', values: [UserOperationStruct[]]): string
  encodeFunctionData(functionFragment: 'validateSignatures', values: [UserOperationStruct[], BytesLike]): string
...
export interface IAggregator extends BaseContract {
  ...
  functions: {
    ...
    validateSignatures(userOps: UserOperationStruct[], signature: BytesLike, overrides?: CallOverrides): Promise<[void]>
