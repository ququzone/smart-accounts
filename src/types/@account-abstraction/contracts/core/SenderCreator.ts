...
export interface SenderCreator extends BaseContract {
  ...
  functions: {
    createSender(initCode: BytesLike, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  }
  ...
  estimateGas: {
    createSender(initCode: BytesLike, overrides?: Overrides & { from?: string }): Promise<BigNumber>
  }

  populateTransaction: {
    createSender(initCode: BytesLike, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
  }
}
