...
export declare namespace IEntryPoint {
  ...
  export type UserOpsPerAggregatorStructOutput = [UserOperationStructOutput[], string, string] & {
...
export interface EntryPointInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_validateSenderAndPaymaster', values: [BytesLike, string, BytesLike]): string
...
export type AccountDeployedEvent = TypedEvent<[string, string, string, string], AccountDeployedEventObject>
...
export type SignatureAggregatorChangedEvent = TypedEvent<[string], SignatureAggregatorChangedEventObject>
...
export interface EntryPoint extends BaseContract {
  ...
  functions: {
    ...
    depositTo(account: string, overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
    ...
    getNonce(sender: string, key: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber] & { nonce: BigNumber }>

    getSenderAddress(initCode: BytesLike, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    incrementNonce(key: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  estimateGas: {
    ...
    depositTo(account: string, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
    ...
    getSenderAddress(initCode: BytesLike, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    incrementNonce(key: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    simulateValidation(userOp: UserOperationStruct, overrides?: Overrides & { from?: string }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    depositTo(account: string, overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    getSenderAddress(initCode: BytesLike, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    incrementNonce(key: BigNumberish, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
